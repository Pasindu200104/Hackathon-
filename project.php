        ...
        <nav class="navbar navbar-expand-custom navbar-mainbg">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0);"><i class="bi-speedometer2" style="font-size: 1rem; color: rgb(149, 149, 149);"></i>Profile</a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="row container-fluid">
            ...
            <div class="container mt-3">
                <div class="row">
                    ...
                    $project_rs = Database::search("SELECT * FROM `project`");
                            ...
                            <div class="col-lg-4 ">
                                <div class="card card-margin" style="background-color: #272727;">
                                    <div class="card-header no-border">
                                        <h5 class="card-title text-white"><?php echo $project_data["project_name"]; ?></h5>
                                    </div>
                                        ...
                                        <div class="widget-49">
                                            <div class="widget-49-title-wrapper">
                                                <div class="widget-49-meeting-info">
                                                    ...
                                                    <span class="widget-49-meeting-time text-white"><?php echo $project_data["project_deadline"]; ?></span>
                                                </div>
                                            </div>
                                            <div class="widget-49-meeting-action">

                                                <button onclick="projectModal('<?php echo $project_data['project_id'] ?>');" class="btn btn-sm btn-flash-border-primary text-white-50">
                                                    View status
                                                </button>

                                            </div>

                                            <div class="modal fade" id="exampleModal<?php echo $project_data["project_id"] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Project status</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <span class="fw-bold"><?php
                                                            $rs8 = Database::search("SELECT * FROM `status` WHERE `status_id`='".$project_data["status_status_id"]."'");
                                                            $data8 = $rs8->fetch_assoc();
                                                            echo($data8["stat"]);
                                                            ?></span>
                                                        </div>
                    ...
                    ?>
                        <div class="row">
                            ...
                            <div class="col-12 d-flex justify-content-center">
                                <span class="fw-bold fs-5 text-white">Oops! There is no projects to show.</span>
                            </div>
                        </div>
                    <?php
                    }
